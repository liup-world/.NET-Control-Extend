...
namespace BobSystem.Controls
{
        ...
        : DataGridView
    {
        ...
        protected override void OnCreateControl()
        {
            ...
            this.panel.Left = 1;
            this.panel.Top = this.Size.Height - 51;
            this.panel.Width = this.Width - 2;
            this.panel.Height = 50;
            this.panel.Anchor = AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            this.panel.SizeChanged += new EventHandler(panelContainer_SizeChanged);
            this.panel.Paint += new PaintEventHandler(panelContainer_Paint);
        ...
        private string getConnectionString()
        {
            ...
            {
                MessageBox.Show("PagingProcedure.ConnString is null.");
            }
        ...
        private void createPagingControl()
        {
            ...
            int containerWidth = this.panel.Width;
            int containerHeight = this.panel.Height;
            ...
            if (PagingMode == PagerMode.PrevNext || PagingMode == PagerMode.NextPrevAndNumeric)
            {
                ...
                this.panel.Controls.Add(btnFirst);
                this.panel.Controls.Add(btnPrevious);
            ...
            if (PagingMode == PagerMode.Numeric || PagingMode == PagerMode.NextPrevAndNumeric)
            {
                ...
                for (; start < end; ++start)
                {
                    ...
                    this.panel.Controls.Add(linkButton);
            ...
            if (PagingMode == PagerMode.PrevNext || PagingMode == PagerMode.NextPrevAndNumeric)
            {
                ...
                this.panel.Controls.Add(btnNext);
                this.panel.Controls.Add(btnLast);
            ...
            this.panel.Controls.Add(txtPageNo);
            this.panel.Controls.Add(btnGo);
            ...
            if (this.ShowRecordInfo)
            {
                ...
                this.panel.Controls.Add(lblRecordInfo);
            ...
            this.panel.Top = this.ClientSize.Height - 51;
            if (base.HorizontalScrollBar.Visible)
            {
                this.panel.Top -= this.HorizontalScrollBar.Height;
            }
        ...
        {
            int oldLeft = this.panel.Controls[0].Left;

            int excursion = (this.panel.Width - this.TotalWidth) / 2 - oldLeft;
            ...
            if (this.ShowRecordInfo)
            {
                Label lblRecordInfo = (Label)this.panel.Controls[this.panel.Controls.Count - 1];
                lblRecordInfo.Left = (this.panel.Width - lblRecordInfo.Width) / 2;
            }
        }
        ...
        private void panelContainer_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(pen, 0, 0, this.panel.Width - 1, 0);
